...
class DBManager:
    ...
    # @staticmethod
    def connection_database(self, sql):
        """
    ...
    def get_companies_and_vacancies_count(self):
        ...
        return self.connection_database("""SELECT name_company, COUNT(name_vacancy) FROM company
    ...
    def get_all_vacancies(self):
        ...
        return self.connection_database("""SELECT name_company, name_vacancy, salary_from, salary_to, alternate_url
                                        FROM vacancy
    ...
    def get_avg_salary(self):
        ...
        return self.connection_database("""SELECT AVG(salary_from) + AVG(salary_to) /2 AS avg_salary
                                        FROM vacancy""")

    def get_vacancies_with_higher_salary(self):
        """Метод, который получает список всех вакансий, у которых зарплата выше средней по всем вакансиям."""
        return self.connection_database("""SELECT name_vacancy
                                        FROM vacancy
