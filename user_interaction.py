...
def main():
    ...
    3. Получить список всех вакансий с указанием названия компании, названия вакансии, зарплаты и ссылки на вакансию
    ...
    6. Получить список всех вакансий по ключевому слову
    """)
    ...
    #     all_vacancies = service.get_vacancies_by_company(name_company)
    #     print(all_vacancies)
    elif choice == "3":
        ...
        for item in data:
            print(
                f"Компания: {item['name_company']}, Вакансия: {item['name_vacancy']}, Зарплата: {item['salary_from']} - "
